...
class XMLtoJSONstream extends stream.Transform {
    constructor(options) {
		...
		this.escapeEndLines = typeof options.escapeEndLines === "undefined" ? false : options.escapeEndLines
    ...
    _final(done) {
        if(this.xml === '') {
            ...
            this.xml = buffer.toString('binary');
        }
        
        const clean =  cleanXML(this.xml, this.escapeEndLines);
